...
public enum LandFlags {
    ...
    VILLAGER_DAMAGE_BY_PLAYER("플레이어가 주민 공격", false, LandFlagSetting.ALLOW, Material.VILLAGER_SPAWN_EGG),
    VILLAGER_DAMAGE_BY_ZOMBIE("좀비가 주민 공격", LandFlagSetting.DENY, Material.ROTTEN_FLESH),
    PROTECT_VILLAGER("플레이어, 좀비를 제외한 모든 공격로부터 주민 보호", LandFlagSetting.ALLOW, Material.LEATHER_CHESTPLATE),
